...
\correct{Sebastian Lisiewski \and \normalsize Paweł Siedlecki}
...
\begin{proof}
	...
	%napisalem słówko wyjasnienia- formalizacja będzie truda, ale widać że jak weźmiemy E na którym jest źle, to zjebie się poprzedni wzór.
	Wówczas:
...
%%	\\\texttt{[\dots]}\\
	...
	\int_\Omega h \dd \mu,$$ o ile można stosować udowodniony wcześniej wzór, czyli jeśli $h$ jest całkowalna z kwadratem. Aby się o tym przekonać, należy liczyć odpowiednie całki po zbiorach $C_n=\{x:\quad g(x)<1-\frac{1}{n}\}$- na nich całki są skończone, czyli na ich sumie także, a o niej wiadomo już że jest pełnej miary. %przyjrzeć się bo nie mam zanotowanej definicji h Edit: jest to oszustwo ale jakoś je wyjasniam
\end{proof}
\begin{wn}
...
\begin{proof}
	...
	\end{enumerate}
\end{proof}
% dorobić odnośnik do lematu 1.6.7
\begin{lem}
...
\end{proof}
\begin{proof}[Dowód twierdzenia spektralnego]%\mbox{}
	...
	\begin{enumerate}[(A)]
		...
		\item %\texttt {na następnym wykładzie}
