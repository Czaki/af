...
\geometry{verbose,a4paper,tmargin=4cm,bmargin=4cm,lmargin=3.0cm,rmargin=3.0cm}
...
\renewcommand{\maketitle}{\begin{titlepage}
	...
	\begin{flushright}
    \begin{minipage}{5cm}
	    \textit{\small Wykładowca:}\\
	    \normalsize \textsc{\@author} \par
		\vspace{3em}	
		\small Notatki Grzegorza Bokoty przy korekcie Sebastiana Lisiewskiego.
	\end{minipage}
	\end{flushright}
\end{titlepage}}
\makeatother
...
\end{proof}
\begin{twr}
	Niech $(X,\|\cdot\|)$ -- przestrzeń unormowana nad ciałem $\K$.
	\begin{enumerate}[(i)]
